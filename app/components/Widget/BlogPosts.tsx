...
const BlogPosts = ({ postData, catagorys }: any) => {
  ...
  return (
    <div className="relative px-4 py-10  md:px-14">
      ...
      {/* Para */}
      {/* Latest News */}
      <div className="Latest over  relative mx-2 overflow-hidden rounded-lg   border-main md:h-80 lg:flex lg:border-2">
          ...
          <div className="mt-10 px-2" key={index + 1}>
            <div className="flex items-center justify-between text-3xl uppercase ">
              <Link
                ...
                className="transition-colors duration-150 ease-linear hover:text-main"
              >
